...
public class SolicitacaoAlunosOrientacaoController {
    ...
    private BorderPane buildCard(Professor prof, Solicitacao s) {
        ...
        // Lixeira sobreposta no canto superior direito
    ...
    private void aceitarSolicitacao(Professor prof, Solicitacao s, BorderPane container, VBox front, VBox back) {
        ...
        // Notificações por e-mail (melhor esforço: loga/exibe toast em falha)
        try (Connection c = ConnectionFactory.getConnection()) {
            ...
            NotificationService notifier = new NotificationService(c, email);
            // Reaproveitamos método existente para notificar aluno em outro fluxo? Aqui enviamos manualmente
            ...
            // silencioso: evita quebrar UX por e-mail
        }
    }
    ...
    private void updateFrontAfterDecision(VBox front, Solicitacao s) {
        // Quando o método recebe uma cópia (new VBox(frontContent)), o verdadeiro conteúdo fica no primeiro filho
        VBox target = front;
