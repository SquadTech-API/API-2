...
/** Controller de recebimento e resposta de agendamentos (orientador). */
public class AgendamentoDefesaOrientadorController {
    ...
    private void refresh(){
        ...
        // somente alunos vinculados a este professor
    ...
    private StackPane buildCard(AgendamentoDefesa a){
        ...
        if ("AGUARDANDO_ORIENTADOR".equals(a.getStatus())) {
            ...
            enviar.setOnAction(e -> {
                ...
                if (d==null||h==null||sala==null||sala.isBlank()||msg==null||msg.isBlank()){ toast("Preencha todos os campos."); return; }
        ...
        // Novo: verso estilizado como card
