...
public class TelaLoginController {
    ...
    void handleLogin(ActionEvent event) {
        ...
        btnSignCadastro.setDisable(true);
        btnSignLogin.setDisable(true);
        ...
        loginTask.setOnSucceeded(e -> {
            ...
            btnSignCadastro.setDisable(false);
            btnSignLogin.setDisable(false);

            Usuario usuario = loginTask.getValue();
            if (usuario != null) {
                // Armazena o usuário na sessão
                SessaoUsuario.setUsuarioLogado(usuario);
                proceedToMainScreen(event, usuario);
            } else {
        ...
        loginTask.setOnFailed(e -> {
            ...
            showAlert("Erro ao conectar ao banco de dados: " + exception.getMessage());
        });
    ...
    private void proceedToMainScreen(ActionEvent event, Usuario usuario) {
        try {
            FXMLLoader loader = new FXMLLoader(
                    Objects.requireNonNull(getClass().getResource("/fxml/login/PainelPrincipal.fxml")));
            ...
            log.error("Erro ao carregar a tela principal", ex);
            showAlert("Erro ao carregar a tela principal: " + ex.getMessage());
        }
    }
    ...
    void initialize() {
        ...
        assert btnSignCadastro != null
                : "fx:id=\"btnSignCadastro\" was not injected: check your FXML file 'TelaLogin.fxml'.";
        ...
        assert paneSignSplit != null
                : "fx:id=\"paneSignSplit\" was not injected: check your FXML file 'TelaLogin.fxml'.";
